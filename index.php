...
<nav class="navbar navbar-expand-lg navbar-dark" style="background: black;">
  <a class="navbar-brand" href="#"><img src="assets/images/logo.jpg"width="50px"></a>
...
<!-- Navigation bar end  -->
  ...
  <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href="https://github.com/prosenjit07">Prosenjit</a> is the owner of this script. For any queries contact me on <a href="https://www.facebook.com/jitroy2350"> Facebook</a> Thanks for staying with me</marquee>
            </div>
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    ...
    <!-- "enctype="multipart/form-data" indicates how the form data should be encoded before sending it to the server. -->
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <select name="grade" class="form-control">
          ...
          <option value="6th">10th</option>
          <option value="7th">11th</option>
          <option value="7th">12th</option>
          <option value="7th">Bachelor's</option>
          <option value="7th">Master's</option>
        </select>
      </div>
  ...
  <hr>
  <a href="https://prosenjit07.github.io/" type="button" class="btn btn-secondary btn-lg btn-block" target="_blank">Prosenjit Chandra Biswas</a>

  <footer class="footer2">
        
        <p style="text-align: center">&copy;2023 <a href="https://prosenjit07.github.io/">Prosenjit</a> | All Rights Reserved</p>
    </footer>
